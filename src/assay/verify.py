...
Generic over the subject: the score face passes a ``ScoreReceipt`` and the effect
face ("Writ") passes an ``EffectReceipt``. One public verifier serves both, because
the envelope signs a subject's canonical JSON without inspecting its fields."""

from __future__ import annotations

from pydantic import BaseModel

from assay.receipt import SignedReceipt, verify_signature
